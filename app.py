...
def updatetorneo():
    ...
    datostor = (
    _nom_torneo, _lugar, _esenario_depor, _nom_organizador, _tel_organizador, _fecha_ini, _fecha_fin, _deporte, id)
    conn = mysql.connect()
    cursor = conn.cursor()
...
def storagetorneo():
    ...
    datostor = (
    _nom_torneo, _lugar, _esenario_depor, _nom_organizador, _tel_organizador, _fecha_ini, _fecha_fin, _deporte)
    conn = mysql.connect()
    cursor = conn.cursor()
    cursor.execute(sql, datostor)
    conn.commit()
